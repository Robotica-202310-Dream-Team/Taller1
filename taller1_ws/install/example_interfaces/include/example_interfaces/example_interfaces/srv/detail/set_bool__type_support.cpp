...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetBool_Request_message_member_array[1] = {
  {
    ...
    offsetof(example_interfaces::srv::SetBool_Request, mensaje),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetBool_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(example_interfaces::srv::SetBool_Response, respuesta),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
