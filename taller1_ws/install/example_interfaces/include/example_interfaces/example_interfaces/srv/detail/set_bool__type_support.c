...
static rosidl_typesupport_introspection_c__MessageMember example_interfaces__srv__SetBool_Request__rosidl_typesupport_introspection_c__SetBool_Request_message_member_array[1] = {
  {
    ...
    offsetof(example_interfaces__srv__SetBool_Request, mensaje),  // bytes offset in struct
    NULL,  // default value
...
static rosidl_typesupport_introspection_c__MessageMember example_interfaces__srv__SetBool_Response__rosidl_typesupport_introspection_c__SetBool_Response_message_member_array[1] = {
  {
    "respuesta",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_STRING,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(example_interfaces__srv__SetBool_Response, respuesta),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
