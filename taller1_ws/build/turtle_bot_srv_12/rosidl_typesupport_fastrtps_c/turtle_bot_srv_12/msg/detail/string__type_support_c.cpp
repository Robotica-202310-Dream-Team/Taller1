...
#include "turtle_bot_srv_12/msg/detail/string__rosidl_typesupport_fastrtps_c.h"
...
using _String__ros_msg_type = turtle_bot_srv_12__msg__String;
...
size_t get_serialized_size_turtle_bot_srv_12__msg__String(
  const void * untyped_ros_message,
...
static uint32_t _String__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_turtle_bot_srv_12__msg__String(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtle_bot_srv_12
size_t max_serialized_size_turtle_bot_srv_12__msg__String(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _String__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtle_bot_srv_12__msg__String(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_bot_srv_12, msg, String)() {
