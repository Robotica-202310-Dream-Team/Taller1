...
{
  new (message_memory) turtle_bot_srv_12::msg::String(_init);
}

void String_fini_function(void * message_memory)
{
  auto typed_message = static_cast<turtle_bot_srv_12::msg::String *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember String_message_member_array[1] = {
  {
    ...
    offsetof(turtle_bot_srv_12::msg::String, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers String_message_members = {
  "turtle_bot_srv_12::msg",  // message namespace
  "String",  // message name
  1,  // number of fields
  sizeof(turtle_bot_srv_12::msg::String),
...
{
  return &::turtle_bot_srv_12::msg::rosidl_typesupport_introspection_cpp::String_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtle_bot_srv_12, msg, String)() {
  return &::turtle_bot_srv_12::msg::rosidl_typesupport_introspection_cpp::String_message_type_support_handle;
}
