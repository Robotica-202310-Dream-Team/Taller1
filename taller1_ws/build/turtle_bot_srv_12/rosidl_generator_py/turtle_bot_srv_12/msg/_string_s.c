...
bool turtle_bot_srv_12__msg__string__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("turtle_bot_srv_12.msg._string.String", full_classname_dest, 36) == 0);
  }
  turtle_bot_srv_12__msg__String * ros_message = _ros_message;
  {  // data
...
PyObject * turtle_bot_srv_12__msg__string__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("turtle_bot_srv_12.msg._string");
