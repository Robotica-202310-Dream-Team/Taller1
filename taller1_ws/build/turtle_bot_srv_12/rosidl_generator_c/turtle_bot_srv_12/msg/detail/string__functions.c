...
turtle_bot_srv_12__msg__String__init(turtle_bot_srv_12__msg__String * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->data)) {
    turtle_bot_srv_12__msg__String__fini(msg);
    return false;
  }
  return true;
}
...
turtle_bot_srv_12__msg__String__create()
{
  ...
  turtle_bot_srv_12__msg__String * msg = (turtle_bot_srv_12__msg__String *)allocator.allocate(sizeof(turtle_bot_srv_12__msg__String), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(turtle_bot_srv_12__msg__String));
  bool success = turtle_bot_srv_12__msg__String__init(msg);
  if (!success) {
...
turtle_bot_srv_12__msg__String__Sequence__init(turtle_bot_srv_12__msg__String__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  turtle_bot_srv_12__msg__String * data = NULL;

  if (size) {
    data = (turtle_bot_srv_12__msg__String *)allocator.zero_allocate(size, sizeof(turtle_bot_srv_12__msg__String), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = turtle_bot_srv_12__msg__String__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        turtle_bot_srv_12__msg__String__fini(&data[i - 1]);
      }
...
turtle_bot_srv_12__msg__String__Sequence__fini(turtle_bot_srv_12__msg__String__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      turtle_bot_srv_12__msg__String__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  turtle_bot_srv_12__msg__String__Sequence * array = (turtle_bot_srv_12__msg__String__Sequence *)allocator.allocate(sizeof(turtle_bot_srv_12__msg__String__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = turtle_bot_srv_12__msg__String__Sequence__init(array, size);
  if (!success) {
...
turtle_bot_srv_12__msg__String__Sequence__destroy(turtle_bot_srv_12__msg__String__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    turtle_bot_srv_12__msg__String__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
turtle_bot_srv_12__msg__String__Sequence__are_equal(const turtle_bot_srv_12__msg__String__Sequence * lhs, const turtle_bot_srv_12__msg__String__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!turtle_bot_srv_12__msg__String__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  turtle_bot_srv_12__msg__String__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(turtle_bot_srv_12__msg__String);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    turtle_bot_srv_12__msg__String * data =
      (turtle_bot_srv_12__msg__String *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!turtle_bot_srv_12__msg__String__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          turtle_bot_srv_12__msg__String__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!turtle_bot_srv_12__msg__String__copy(
